    ...
    <div class="common-view">
        <div class="function-zone" >
            <div class="global-op-mid" style="float: left">
                ...
                <el-button type="primary" @click="newPolicy" class="my-el-button-left" :disabled="true">查询</el-button>
            </div>
            <div class="global-op-left" style="float: right">
                ...
                <el-button type="primary" @click="newPolicy" :disabled="true" class="my-el-button-right">批量删除</el-button>
            </div>
            <div class="el-dialog-modul">
                <el-dialog title="新建策略" :visible.sync="dialogFormVisible">
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                description: [
                    { required: true, message: '请输入策略描述信息', trigger: 'blur' },
                    { min: 5, max: 30, message: '长度在 5 到 30 个字符', trigger: 'blur' }
                ],
                startDateTime: [
                    { type: 'datetime', required: true, message: '请为策略选择开始时间', trigger: 'change' }
                ],
                interval: [
                    {  required: true, message: '请输入策略执行周期', trigger: 'blur' },
